...
switch (getGame) {
  case false:
    alert("Ах так тварюко? Мольфар Єфродозій знає про тебе все! Усі твої брудні думки та подробиці твого ещасного життя! Скинь 17грн на ЗСУ! Бо всім розкажу чим ти займаєшся коли наодинці із собою!");
    break;
  case true:
    for (i = 0; i <= 5; i += 1) {
      question = prompt(
